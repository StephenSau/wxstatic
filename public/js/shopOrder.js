(function () {
    ...
    OrderCommit.prototype = {
        init: function () {
            ...
            this.fillSelect();
            this.listener();
            /*fixnav order trigger submit*/
            document.querySelector(".orderSumbit").addEventListener('click',function(){
                fireEvent(document.querySelector("#orderCommit"),"submit");
            } , false);
        },
        ...
        listener: function () {
            ...
            document.getElementById('cancelImgCodeBtn').addEventListener('click', function () {
                that.cancelImageCode();
            }, false);
        ...
        cancelImageCode :function(){
            document.getElementById('mask').style.display="none";
            document.getElementById('ui_codeBox').style.display ="none";
        }
    };
